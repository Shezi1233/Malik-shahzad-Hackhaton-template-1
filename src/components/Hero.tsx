    ...
    return(
        <main className=" max-w-screen-2xl mx-auto w-full h-full md:h-[500px] flex flex-col md:flex-row justify-between items-start bg-[#F2F0F1]">
         ...
         <div className="w-full md:w-[500px] mt-3 md:mt-10 md:ml-10 pl-3">
            ...
            <p className="text-sm md:mt-3 text-gray-600">Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.</p>
            <a href="casual">
            <button className="bg-black py-2 px-8 rounded-full mt-4  text-white text-sm">Shop Now</button>
            </a>
         </div>
         {/* right */}
